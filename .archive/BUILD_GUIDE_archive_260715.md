# Archive: AIHack Build Guide historical full snapshot

- Archived: 2026-07-15
- Source: [BUILD_GUIDE.md](../BUILD_GUIDE.md)
...
Phase 16+ 현재 기준 출력 예시:

```text
seed=42 turns=0 final_turn=0 final_hash=53435bb29a2e69ee
seed=42 turns=100 final_turn=20 final_hash=569bc36895258349
seed=43 turns=100 final_turn=21 final_hash=78f305383cde9bb0
seed=42 turns=1000 final_turn=20 final_hash=569bc36895258349
```

Historical baseline (Phase 10):
