# AIHack Master Spec — Archive

> 📂 Archived: 2026-07-15
> 🔗 Previous archive: First archive
> 📄 Source document: `spec.md` (continues with v2)
> 🧬 DNA inherited in source: 결정론적 코어, GameSession 단일 상태 원천, Observation/ActionIntent 경계, 레거시 직접 import 금지
