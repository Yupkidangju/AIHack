...
| G-CORE-006 | P0 | submit-only master와 broader public World/system mutation 불일치 | default visibility 축소, testing feature 격리와 `59c8872` external compile/full local GREEN | report 30 시정 | R30-IMP-F001, FIN-F005 | Verified |
...
| G-DOC-008 | P0 | designs/compatibility/remediation/roadmap active lifecycle 누락 | report 30 단일 authority와 모든 active header common negative gate, `59c8872` full local GREEN | report 30 시정 | R29-DOC-F002 Re-audit #1, FIN-F012 | Verified |
...
| G-FINAL-001 | P0 | final multi-audit FIN-F001..F018 및 report 30 독립 재감사 HOLD | `59c8872` 전체 local/clean Windows actual bundle Verified; 새 양 OS CI·독립 감사 pending | report 30 remediation | report 30 finding과 FIN-F001..F018 | Verified |
...
R0~R8 기존 remediation과 report 23/24는 역사적으로 종결됐다. report 25는 partial, report 26~29는 historical/technical evidence로 보존한다. 현재 authority는 `docs/audit/audit_report_30.md`이며 G-CORE-006/G-DOC-008/G-FINAL-001은 `59c8872` 전체 local/clean Windows actual bundle로 Verified다. 새 양 OS CI·독립 감사와 별도 게시 승인 전까지 Closed 및 program/publication PASS로 올리지 않는다.
