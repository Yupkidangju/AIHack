...
| G-BUILD-006 | P0 | dependency exception lifecycle/graph drift | future approval와 전체 YAML action pin을 시정하고 SHA `fc01ec12` Actions `32658658526` cargo-deny 0.19.4 양 OS success | report 26 시정 | SC-BUILD-01, SC-LICENSE-01 | Verified |
...
| G-TEST-003 | P0 | R9 causal witness 원인별 독립성 | 9종 actual producer removal과 production pair matrix, SHA `fc01ec12` Actions `32658658526` 양 OS success | report 26 시정 | SC-CAUSE-05, SC-CAUSE-06, SC-CAUSE-07 | Verified |
...
| G-DOC-004 | P0 | 과거 finding과 현재 권한 상태 혼재 | report 26 authority, GoldScore/producer-removal과 terminal evidence 경계를 active docs/test로 분리; Actions `32658658526` | report 26 시정 | SC-DOC-01 | Verified |
...
| G-SEC-001 | P0 | artifact link/root/ambient path 경계 | Windows alias, fresh staging, root/nested reparse와 hard-link 회귀 및 actual 양 OS bundle `32658658526` | report 26 시정 | SEC-F001, FIN-F004, FIN-F014 | Verified |
...
| G-FINAL-001 | P0 | final multi-audit FIN-F001..F018 및 report 26 독립 재감사 HOLD | report 26 RED/GREEN, 전체 local gate와 SHA `fc01ec12` Actions `32658658526` 양 OS success; 독립 재감사 pending | report 26 remediation | report 26 finding 12건과 FIN-F001..F018 | Verified |
