...
| G-DOC-009 | P0 | implementation summary 10·11절 predecessor current/completed-work false-green | ADR-0041, summary 1·10·11 exact-one 및 report 번호 기반 generic mutation RED/GREEN | report 31 시정 | R29-DOC-F002 Re-audit #2, FIN-F012 | Implemented |
...
| G-FINAL-001 | P0 | final multi-audit FIN-F001..F018 및 report 31 문서 재감사 HOLD | report 30 `ed02dbf/32733235414` 기술/API·독립 Verified; report 31 summary lifecycle 시정은 Implemented | report 31 remediation | R29-DOC-F002 Re-audit #2, FIN-F001..F018 | Implemented |
...
현재 authority는 `docs/audit/audit_report_31.md`다. G-DOC-009/G-FINAL-001은 summary lifecycle 시정의 전체 local gate와 새 clean same-SHA 양 OS evidence가 끝날 때까지 Implemented이며, 후속 독립 감사와 별도 게시 승인 전까지 Closed 및 program/publication PASS로 올리지 않는다.
