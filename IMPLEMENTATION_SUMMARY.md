...
- **현재 버전**: v2.23.0 (Phase 2 기능 연동 완료)
- **최근 업데이트**: 2026-02-26
- **원본 소스**: 177,232 라인 (C 소스) + 20,097 라인 (헤더) = **197,329 라인**
- **현재 Rust**: **148,644 라인** (344개 파일) [2026-02-26 실측치]
- **이식률**: **85.8%** (C 소스 기준)
- **테스트**: **3,318개** 전체 통과 [2026-02-26 실측치]
- **Bridge Layer**: **12개** (7개 기존 + 5개 Phase 2 신규)
- **목표**: **100%**

---

## 모듈별 구현 현황 (2026-02-27 v2.41.0 실측치) 💯 **100%** 🏆 이식 완료!
...
| **[v2.22.0 R34 추가]** | | | | |
| `attrib_ext2.rs` | 660 | `attrib.c` | 932 | ~71% |
| `artifact_ext.rs` (신규) | 700 | `artifact.c` | 2,206 | ~32% |
| `detect_ext.rs` (확장) | 590 | `detect.c` | 2,033 | ~29% |
| `polyself_ext.rs` | 520 | `polyself.c`+`botl.c` | 1,776 | ~29% |
| `role_selection_ext.rs` | 340 | `role.c` | 2,088 | ~16% |
| `pager_ext.rs` | 400 | `pager.c` | 1,577 | ~25% |
| `mplayer_ext.rs` | 360 | `mplayer.c`+`mkobj.c` | 386 | ~93% |
| `u_init_ext.rs` | 250 | `u_init.c` | 886 | ~28% |
| `dog_ext.rs` | 300 | `dog.c` | 1,064 | ~28% |
| `dogmove_ext.rs` | 340 | `dogmove.c` | 1,435 | ~24% |
| `monmove_ext.rs` | 320 | `monmove.c` | 1,738 | ~18% |
| `mon_ext.rs` | 280 | `mon.c` | 4,265 | ~7% |
| `hack_ext.rs` | 250 | `hack.c` | 3,177 | ~8% |
...
| **v2.22.0** | **147,120** | **3,288** | **R34 대량 이식: makemon_ext~objnam_ext2 22개 모듈, 338파일 — 85.2%** |
| **v2.23.0** | **148,644** | **3,318** | **Phase 2 기능 연동: status/terrain/spell/monster_ai/social Bridge 5개 + integration_r34 통합 시나리오, 344파일 — 85.8%** |
