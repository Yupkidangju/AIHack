...
Notice ID: `AIHACK-MODIFICATIONS-2026-08-23-02`
...
| --- | --- | --- |
| `src/**` | 2025-05-20..2026-08-23 | Rust compatibility facade and project entry library |
| `crates/**` | 2025-05-20..2026-08-23 | Deterministic core, content, AI contracts, LLM adapter and runtime rewrite |
| `apps/**` | 2025-05-20..2026-08-23 | TUI and headless application adapters |
| `tests/**` | 2025-05-20..2026-08-23 | AIHack behavior, compatibility, security and release verification |
| `scripts/**` | 2025-05-20..2026-08-23 | Build, checkpoint, deterministic fixture and PTY verification tooling |
| `docs/**` | 2025-05-20..2026-08-23 | Compatibility, provenance and implementation documentation |
| `.archive/**` | 2025-05-20..2026-08-23 | Immutable AIHack planning and design snapshots |
| root Cargo/build/config files | 2025-05-20..2026-08-23 | Rust workspace, dependency, CI and release configuration |
| root project documents | 2025-05-20..2026-08-23 | Specification, decisions, provenance, license and release guidance |
