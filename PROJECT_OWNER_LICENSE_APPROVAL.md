...
archive와 output의 `RELEASE-METADATA`는 `owner_approval=AIHACK-OWNER-2026-07-20-NGPL-01`과 `modification_notice=AIHACK-MODIFICATIONS-2026-08-23-02`를 각각 정확히 한 번 포함하며, 두 값 전체는 함께 배포되는 각 record의 ID와 일치해야 한다. 후자는 2026-08-23까지 포함하는 v0.3.0 candidate의 갱신된 modification record다.
