...
- Phase 15 실행 대상: `cargo run -- --seed 42`
...
- Phase 15 v0.2 accessibility polish: hover read-only inspect, priority message, command hint, inspect-panel inventory click, reduced motion/high-contrast presentation path
- Phase 13 validator-gated LLM decision support, Phase 12 narrative-only adapter, Phase 11 AI API freeze, Phase 10 ASCII TUI adapter, layout/input/effect smoke, Phase 9 save/load/replay, Phase 8 golden-rule absorption, Phase 7 hidden door/trap search, wand zap, throw item, scroll reveal, and Phase 6 current-level monster AI
...
- Phase 15 runner: `cargo run -- --seed 42`
...
- Phase 15 v0.2 accessibility polish: hover read-only inspect, priority messages, command hints, inspect-panel inventory clicks, and reduced-motion/high-contrast presentation path
- Phase 13 validator-gated decision support, Phase 12 narrative-only adapter, Phase 11 AI API freeze, Phase 10 ASCII TUI adapter, layout/input/effect smoke, Phase 9 save/load/replay, Phase 8 golden-rule absorption, Phase 7 hidden-door/trap search, wand zap, thrown items, scroll reveal, and Phase 6 current-level monster AI
...
- Phase 15 ランナー: `cargo run -- --seed 42`
...
- Phase 15 v0.2 accessibility polish、hover read-only inspect、priority message、command hint、inspect panel inventory click、reduced-motion/high-contrast presentation path
- Phase 13 validator-gated decision support、Phase 12 narrative-only adapter、Phase 11 AI API freeze、Phase 10 ASCII TUI adapter、layout/input/effect smoke、Phase 9 save/load/replay、Phase 8 golden-rule absorption、Phase 7 hidden door/trap search、wand zap、throw item、scroll reveal、Phase 6 current-level monster AI
