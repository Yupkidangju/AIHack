...
| **v2.41.1** | **2026-03-29** | **💯 100%** | **게임 플레이 안정화: ECS AccessDenied 해결, 맵 생성/몬스터 스폰 원본화, Grid 동기화 파이프라인 진행 중** |
...
| S5c | ⬜ 대기 | 인벤토리/전투/마법 명령어 연결 (Wield/Wear/Eat/Quaff UI 필요) |
| S6 | ⬜ 대기 | Edge Case 방어 (세이브/로드, 레벨 변경 등) |
| S7 | ⬜ 대기 | LLM 최소 주입 (묘비명 → NPC 대사 → 상점) |
