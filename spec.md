...
작성일: 2026-07-15
목표 버전: 0.3.0
현재 코드 기준: Cargo package 0.3.0, report 29 기술 successor `a91a9c7/32706869079`은 Verified. 현재 권위 `docs/audit/audit_report_30.md`의 ADR-0040 active authority/default public visibility 구현과 표적 GREEN은 완료했고 전체 local gate·새 clean same-SHA 양 OS CI가 pending이다. 후속 독립 재감사와 별도 게시 승인 전까지 PROGRAM/PUBLICATION HOLD를 유지한다.
